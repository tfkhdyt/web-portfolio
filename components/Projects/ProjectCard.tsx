...
const ProjectCard = ({
  ...
  return (
    ...
    >
      <div
        className={`relative aspect-video w-full rounded-2xl shadow-lg transition duration-500`}
      >
        <div
          className={`absolute inset-0 z-10 grid aspect-video h-full w-full place-items-center rounded-2xl bg-black/75 px-4 py-3 text-center text-white transition duration-500 ${
          ...
          <div>
            ...
            <div className='space-x-1'>
              {tags.map((tag) => (
                <div
                  data-theme='light'
                  className='badge badge-sm badge-info py-2 font-bold'
                  key={tag}
                >
                  {tag}
                </div>
